...
public class ToastUtils {
    ...
    public static void showShortToast(String msg) {
        if(GraduateDesignApplication.getAppContext() != null){
            if (toast == null) {
                toast = Toast.makeText(GraduateDesignApplication.getAppContext(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            ...
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(GraduateDesignApplication.getAppContext(),64));
            toast.show();
        }
    }
    /**
    ...
    public static void showLongToast(String msg) {
        if(GraduateDesignApplication.getAppContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(GraduateDesignApplication.getAppContext(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(GraduateDesignApplication.getAppContext(),64));
